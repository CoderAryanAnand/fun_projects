...
driver = webdriver.Chrome(
    executable_path="C:/Users/iitda/.wdm/drivers/chromedriver/83.0.4103.39/win32/chromedriver.exe")
...
class Coronavirus():
    ...
    def get_data(self):
        try:
            ...
            country_element = table.find_element_by_xpath("//td[contains(text(), 'Switzerland')]")
