...
class popupWindow(object):
    ...
    def __init__(self, master):
        ...
        self.l = Label(top, text=" Password: ", font=('sansserif', 14), justify=CENTER)
        self.l.pack()
        self.e = Entry(top, show='*', width=30)
        self.e.pack(pady=7)
        self.b = Button(top, text='Submit', command=self.cleanup, font=('sansserif', 14))
        self.b.pack()
...
class entity_display:
    ...
    def __init__(self, master, n, e, p, i):
        ...
        self.label_name = Label(self.window, text=dencryptedN, font=('sansserif', 14))
        self.label_email = Label(self.window, text=dencryptedE, font=('sansserif', 14))
        self.label_pass = Label(self.window, text=dencryptedP, font=('sansserif', 14))
...
entity_label = Label(window, text='Add Entity', font=('sansserif', 18))
name_label = Label(window, text='Name: ', font=('sansserif', 14))
email_label = Label(window, text='Email: ', font=('sansserif', 14))
pass_label = Label(window, text='Password: ', font=('sansserif', 14))
name = Entry(window, font=('sansserif', 14))
email = Entry(window, font=('sansserif', 14))
password = Entry(window, show='*', font=('sansserif', 14))
submit = Button(window, text='Add Email', command=onsubmit, font=('sansserif', 14))
...
name_label2 = Label(window, text='Name: ', font=('sansserif', 14))
email_label2 = Label(window, text='Email: ', font=('sansserif', 14))
pass_label2 = Label(window, text='Password: ', font=('sansserif', 14))
...
storage.child("passwords").put("emails.txt")
